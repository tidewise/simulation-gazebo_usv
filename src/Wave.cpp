...
Wave::Effects Wave::computeEffects(Vector3d const wave_amplitude_world, Vector3d const wave_frequency_world) const
{
    ...
    wave_effects.torque[0] = wave_coeff_time_n * wave_amplitude_world.Length() * mParameters.torque_constant;
    return wave_effects;
}
...
void Wave::update()
{
    ...
    Effects effects = computeEffects(mWaveAmplitude, mWaveFrequency);
